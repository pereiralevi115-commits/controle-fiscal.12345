...
export default function CTeReport({ open, onClose, invoices, branches }) {
  ...
  const handleGeneratePDF = () => {
    ...
    try {
      ...
      const drawHeader = () => {
        ...
        pdf.setFont(undefined, "bold");
        pdf.text("Relatório CT-e", margin, y + 5);
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto p-0">
        <div className="sticky top-0 bg-white border-b p-6 flex items-center justify-between gap-4 flex-wrap z-10">
          <DialogTitle className="text-xl">Relatório CT-e</DialogTitle>
        ...
        <div className="p-6 space-y-4 text-sm">
          <div className="flex items-start justify-between border-b-2 border-slate-800 pb-3 mb-2 gap-6">
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-slate-800">Relatório CT-e</h1>
