...
export default function Dashboard() {
  ...
  // Todo o cálculo pesado (filtros/agrupamentos/somas sobre milhares de notas)
  // fica memoizado: só recalcula quando os dados ou os filtros mudam, em vez de
  // a cada render — o que travava a thread principal e reiniciava a aba.
  ...
  }, [invoices, cteList, nfseList, branches, suppliers, allowedCnpjs, user, userProfile, startDate, endDate, isLoading, canAccessPage]);
