      ...
      <div className="max-w-full mx-auto p-4 md:p-8 space-y-6">
        ...
        <Tabs defaultValue="nfe" className="space-y-6">
          ...
          <TabsContent value="nfe" className="mt-0">
            <CategoryInvoiceTab documentType="nfe" supplierFlag="gestao_frota" branches={branches} />
          </TabsContent>
          <TabsContent value="nfse" className="mt-0">
            <CategoryInvoiceTab documentType="nfse" supplierFlag="gestao_frota" branches={branches} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
